...
fn help_lines() -> Vec<Line<'static>> {
    ...
    vec![
        ...
        Line::from(vec![Span::raw("  F5 Copy  F6 Move  F7 New dir  F8 Delete  F9 Size  F10 Quit")]),
        Line::from(""),
        Line::from(vec![Span::styled("Shortcuts", cyan), Span::raw(": Ctrl+O  Shell   Ctrl+R  Refresh   Ctrl+T  View mode")]),
